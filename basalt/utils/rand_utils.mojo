...
@always_inline
fn rand_uniform[dtype: DType](mut res: Tensor[dtype], low: Scalar[dtype], high: Scalar[dtype]):
    var scale = high - low
...
@always_inline
fn rand_normal[dtype: DType](mut res: Tensor[dtype], mean: Float64, std: Float64):
